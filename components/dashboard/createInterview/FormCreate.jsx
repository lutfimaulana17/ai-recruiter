...
const FormCreate = ({ onHandleInputChange, onNext }) => {
    ...
    const handleAddInterviewType = (type) => {
    ...
    return (
        <div className='p-5 bg-white rounded-xl'>
                        ...
                        <div key={index}
                         ...
                         gap-2 p-1 px-4 bg-white border
                          ...
                          ${interviewType.includes(type.title) && 'bg-blue-100 text-primary'} `}
                            onClick={() => handleAddInterviewType(type.title)} >
            ...
            <div className='mt-7 flex justify-end' onClick={() => onNext()}>
